...
const Produkty = forwardRef((props, ref) => {
    ...
    return(
      <section ref={ref} style={{backgroundImage: `url(${produktyImg})`}} className='h-screen bg-secondary w-full text-center bg-contain bg-center bg-no-repeat text-text'>
        <div className='p-10 pb-0 xl:p-10'>
          <h2 className='text-3xl xl:text-5xl p-2'>Firma je pouhým <span className='text-primary font-semibold'>začátkem!</span></h2>
          <p className='text-lg xl:text-2xl'>Vizionářská síla v digitálním prostředí, kde se vydáváme<br/>na cestu k novému vymezení vaší online prezentace.</p>
        </div>
        <div className='flex justify-center'>
          <div className='w-7/12'>
            <div data-aos="fade-left" className='w-full xl:mt-12 flex xl:justify-end justify-center'> 
            ...
            <div data-aos="fade-right" className='w-full mt-52 xl:mt-52 flex justify-center xl:justify-start'>
              <div className='w-96'>
