    ...
    return(
      <section ref={ref} className='h-full bg-secondary flex flex-col items-center relative'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 m-5 gap-4 w-3/4'>
          <img onClick={() => setSelected(gallery1)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery1} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery2)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery2} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery3)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery3} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery4)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery4} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery5)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery5} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery6)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery6} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery7)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery7} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery8)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery8} alt='Obrázek'/>
          <img onClick={() => setSelected(gallery9)} className='w-auto hover:scale-105 transition cursor-pointer' src={gallery9} alt='Obrázek'/>
        </div>
